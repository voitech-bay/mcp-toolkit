...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/context-snapshots", name: "ContextSnapshots", component: () => import("../views/ContextSnapshotsPage.vue"), meta: { title: "Saved Reply Contexts | MCP Toolkit" } },
    ...
    {
      path: "/velvetech/analytics",
      name: "VelvetechAnalytics",
      component: () => import("../views/VelvetechAnalyticsPage.vue"),
      meta: { title: "Velvetech analytics | Voitech" },
    },
    {
    ...
    },
    {
      ...
      meta: { title: "Hermes Agent | Voitech" },
    },
    {
      path: "/plays",
      name: "Plays",
